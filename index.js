...
async function handler() {
  ...
  app.message("pair", async (args) => {
    ...
    const { pairs, existingPairs } = generatePairs({ users: filteredUsers });

    const pairInstances = await initiateConversation({ pairs, client, say });
...
function generatePairs({ filteredUsers }) {
